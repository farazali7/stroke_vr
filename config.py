cfg = {
    'PATHS': {
        ...
        'FEATURE_DATA': 'data/features/v3',  # Which version of features data file to use for modelling
        'RESULTS': 'results/'  # Directory to save result files into
    },
    ...
    'RESPONSE_VARS': ['perceived_exertion', 'perceived_enjoyment', 'game_performance'],  # Response variables to use as targets
    'SAMPLING_RATE': 30,  # Hz
